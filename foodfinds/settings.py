"""
Django settings for foodfinds project.
...
SECRET_KEY = 'django-insecure--x*)gdctr%s_w70nhg9ds5a1(0)%#()8km+9*a0yzr&s8r1-u7'
...
WSGI_APPLICATION = 'foodfinds.wsgi.application'
